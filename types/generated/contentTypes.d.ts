...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<['blocks.hero-section-1']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiNewsletterContactNewsletterContact
  extends Struct.CollectionTypeSchema {
  collectionName: 'newsletter_contacts';
  info: {
    displayName: 'Newsletter Contact';
    pluralName: 'newsletter-contacts';
    singularName: 'newsletter-contact';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::newsletter-contact.newsletter-contact'
    > &
      Schema.Attribute.Private;
    message: Schema.Attribute.Text;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['Request Collaborated', 'Personal']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      [
        ...
        'blocks.solar-sister-block',
        'blocks.net-zero-heroes-block',
        'blocks.gawirea-lab',
        'blocks.gawirea-edu-hub-block',
        'blocks.mojuk-block',
        'blocks.sinari-project-block',
        'blocks.impact-block',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::newsletter-contact.newsletter-contact': ApiNewsletterContactNewsletterContact;
